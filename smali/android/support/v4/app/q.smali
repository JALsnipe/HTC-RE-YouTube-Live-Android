...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/q;->z:Landroid/view/animation/Interpolator;
...
.method constructor <init>()V
    ...
    .line 434
    iput-object v1, p0, Landroid/support/v4/app/q;->w:Landroid/os/Bundle;

    .line 435
    iput-object v1, p0, Landroid/support/v4/app/q;->x:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Landroid/support/v4/app/q;->y:Ljava/lang/Runnable;
...
.method static a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    .line 739
    sget-object v1, Landroid/support/v4/app/q;->z:Landroid/view/animation/Interpolator;
...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    .line 449
    iget-object v0, p0, Landroid/support/v4/app/q;->o:Landroid/support/v4/app/i;
...
.method private t()V
    ...
    .line 1346
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/q;->u:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/app/q;->u:Ljava/lang/String;
...
.method public a()Landroid/support/v4/app/z;
    .locals 1
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/b;-><init>(Landroid/support/v4/app/q;)V
...
.method public a(II)V
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/support/v4/app/s;-><init>(Landroid/support/v4/app/q;II)V
...
.method a(IIIZ)V
    ...
    .line 1115
    :cond_4
    iget-boolean v0, p0, Landroid/support/v4/app/q;->r:Z
    ...
    .line 1117
    iput-boolean v5, p0, Landroid/support/v4/app/q;->r:Z
...
.method a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    iget-object v5, p0, Landroid/support/v4/app/q;->o:Landroid/support/v4/app/i;
    ...
    .line 1790
    iget-object v3, p0, Landroid/support/v4/app/q;->o:Landroid/support/v4/app/i;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/q;)Landroid/support/v4/app/b;
    ...
    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/q;->a(ILandroid/support/v4/app/b;)V
...
.method public a(Landroid/support/v4/app/Fragment;)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/q;->v:Z
...
.method public a(Landroid/support/v4/app/Fragment;II)V
    ...
    .line 1197
    iput-boolean v1, p0, Landroid/support/v4/app/q;->r:Z
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->mActivity:Landroid/support/v4/app/i;
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/app/au;-><init>(Ljava/lang/String;)V
    ...
    .line 917
    iget-object v0, p0, Landroid/support/v4/app/q;->p:Landroid/support/v4/app/n;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v4/app/t;-><init>(Landroid/support/v4/app/q;Landroid/support/v4/app/Fragment;)V
    ...
    .line 1069
    :cond_2e
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->mActivity:Landroid/support/v4/app/i;
...
.method public a(Landroid/support/v4/app/Fragment;Z)V
    ...
    .line 1181
    iput-boolean v3, p0, Landroid/support/v4/app/q;->r:Z
...
.method public a(Landroid/support/v4/app/i;Landroid/support/v4/app/n;Landroid/support/v4/app/Fragment;)V
    ...
    .line 1868
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/q;->o:Landroid/support/v4/app/i;

    .line 1869
    iput-object p2, p0, Landroid/support/v4/app/q;->p:Landroid/support/v4/app/n;
...
.method public a(Ljava/lang/Runnable;Z)V
    ...
    .line 1361
    invoke-direct {p0}, Landroid/support/v4/app/q;->t()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/q;->y:Ljava/lang/Runnable;
...
.method a(Landroid/os/Handler;Ljava/lang/String;II)Z
    ...
    .line 1557
    iget-object v4, p0, Landroid/support/v4/app/q;->i:Ljava/util/ArrayList;
...
.method public b()Z
    ...
    .prologue
    .line 472
    invoke-virtual {p0}, Landroid/support/v4/app/q;->e()Z
...
.method public c(Landroid/support/v4/app/Fragment;II)V
    ...
    .line 1238
    iput-boolean v4, p0, Landroid/support/v4/app/q;->r:Z
...
.method d()V
    ...
    .line 1128
    invoke-virtual {p0, v0}, Landroid/support/v4/app/q;->a(Landroid/support/v4/app/Fragment;)V
...
.method public d(Landroid/support/v4/app/Fragment;II)V
    ...
    .line 1255
    iput-boolean v2, p0, Landroid/support/v4/app/q;->r:Z
...
.method e(Landroid/support/v4/app/Fragment;)V
    ...
    .line 1592
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/q;->x:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Landroid/support/v4/app/q;->x:Landroid/util/SparseArray;

    .line 1597
    :goto_1
    iget-object v0, p1, Landroid/support/v4/app/Fragment;->mInnerView:Landroid/view/View;

    iget-object v1, p0, Landroid/support/v4/app/q;->x:Landroid/util/SparseArray;
...
.method public e()Z
    ...
    .line 1462
    iget-object v1, p0, Landroid/support/v4/app/q;->o:Landroid/support/v4/app/i;

    iget-object v1, v1, Landroid/support/v4/app/i;->a:Landroid/os/Handler;

    iget-object v4, p0, Landroid/support/v4/app/q;->y:Ljava/lang/Runnable;
    ...
    .line 1483
    iput-boolean v2, p0, Landroid/support/v4/app/q;->v:Z
...
.method f(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    .line 1605
    .line 1607
    iget-object v0, p0, Landroid/support/v4/app/q;->w:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/q;->w:Landroid/os/Bundle;
...
.method f()V
    ...
    invoke-interface {v0}, Landroid/support/v4/app/p;->a()V
...
.method h()Landroid/os/Parcelable;
    ...
    .line 1678
    invoke-virtual {p0, v0}, Landroid/support/v4/app/q;->f(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    invoke-direct {v4, p0, v0}, Landroid/support/v4/app/BackStackState;-><init>(Landroid/support/v4/app/q;Landroid/support/v4/app/b;)V
...
.method public i()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/q;->s:Z
...
.method public r()V
    ...
    .line 1922
    iput-object v1, p0, Landroid/support/v4/app/q;->o:Landroid/support/v4/app/i;

    .line 1923
    iput-object v1, p0, Landroid/support/v4/app/q;->p:Landroid/support/v4/app/n;
