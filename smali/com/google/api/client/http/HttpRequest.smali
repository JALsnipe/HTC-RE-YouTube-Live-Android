...
# static fields
.field public static final USER_AGENT_SUFFIX:Ljava/lang/String; = "Google-HTTP-Java-Client/1.17.0-rc (gzip)"

.field public static final VERSION:Ljava/lang/String; = "1.17.0-rc"
...
.method public execute()Lcom/google/api/client/http/HttpResponse;
    ...
    invoke-virtual {v2, v3, v13}, Lcom/google/api/client/http/HttpTransport;->buildRequest(Ljava/lang/String;Ljava/lang/String;)Lcom/google/api/client/http/LowLevelHttpRequest;
    ...
    const-string v9, "Google-HTTP-Java-Client/1.17.0-rc (gzip)"
    ...
    invoke-static {v5, v3, v2, v15, v14}, Lcom/google/api/client/http/HttpHeaders;->serializeHeaders(Lcom/google/api/client/http/HttpHeaders;Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;Ljava/util/logging/Logger;Lcom/google/api/client/http/LowLevelHttpRequest;)V
    ...
    invoke-direct {v4, v5, v9, v10, v0}, Lcom/google/api/client/util/LoggingStreamingContent;-><init>(Lcom/google/api/client/util/StreamingContent;Ljava/util/logging/Logger;Ljava/util/logging/Level;I)V
    ...
    invoke-virtual {v14, v0}, Lcom/google/api/client/http/LowLevelHttpRequest;->setContentType(Ljava/lang/String;)V

    .line 940
    invoke-virtual {v14, v4}, Lcom/google/api/client/http/LowLevelHttpRequest;->setContentEncoding(Ljava/lang/String;)V

    .line 941
    invoke-virtual {v14, v9, v10}, Lcom/google/api/client/http/LowLevelHttpRequest;->setContentLength(J)V

    .line 942
    invoke-virtual {v14, v5}, Lcom/google/api/client/http/LowLevelHttpRequest;->setStreamingContent(Lcom/google/api/client/util/StreamingContent;)V
    ...
    invoke-virtual {v14, v3, v4}, Lcom/google/api/client/http/LowLevelHttpRequest;->setTimeout(II)V

    .line 965
    :try_start_0
    invoke-virtual {v14}, Lcom/google/api/client/http/LowLevelHttpRequest;->execute()Lcom/google/api/client/http/LowLevelHttpResponse;
    :try_end_0
    ...
    const-string v10, "Google-HTTP-Java-Client/1.17.0-rc (gzip)"
