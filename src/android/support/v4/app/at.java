...
class at
{
    ...
    public at(Context context, Notification notification, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, RemoteViews remoteviews, int i, 
            ...
            int l, CharSequence charsequence3)
    {
        ...
        a = builder3.setFullScreenIntent(pendingintent1, flag5).setLargeIcon(bitmap).setNumber(i).setUsesChronometer(flag1).setPriority(l).setProgress(j, k, flag);
    }
    ...
    public void a(CharSequence charsequence, boolean flag, CharSequence charsequence1, Bitmap bitmap, Bitmap bitmap1, boolean flag1)
    {
        android.app.Notification.BigPictureStyle bigpicturestyle = (new android.app.Notification.BigPictureStyle(a)).setBigContentTitle(charsequence).bigPicture(bitmap);
        if (flag1)
        {
    ...
    public void a(CharSequence charsequence, boolean flag, CharSequence charsequence1, CharSequence charsequence2)
    {
        android.app.Notification.BigTextStyle bigtextstyle = (new android.app.Notification.BigTextStyle(a)).setBigContentTitle(charsequence).bigText(charsequence2);
        if (flag)
        {
    ...
    public void a(CharSequence charsequence, boolean flag, CharSequence charsequence1, ArrayList arraylist)
    {
        android.app.Notification.InboxStyle inboxstyle = (new android.app.Notification.InboxStyle(a)).setBigContentTitle(charsequence);
        if (flag)
        {
