...
class cw extends Drawable
{

    final HtcIconButton a;
    private Drawable b;
    private Drawable c;
    private Drawable d;
    private int e;

    public cw(HtcIconButton htciconbutton, Context context)
    {
        this(htciconbutton, context, null, m.HtcButton);
    }

    public cw(HtcIconButton htciconbutton, Context context, AttributeSet attributeset, int i)
    {
        a = htciconbutton;
        super();
        e = cc.a(htciconbutton.getBackgroundMode());
        d = null;
