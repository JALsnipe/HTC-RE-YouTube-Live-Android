    ...
    implements Callable
{
    ...
    private void a(String s)
    {
        ...
        Log.d("GcWifiRemoveGroupCallable", (new StringBuilder("[MGCC][MPerf] [")).append(s).append("] costs: ").append(l).append(" ms").toString());
    }
    ...
    protected void a(e e1)
    {
        ...
        Log.d("GcWifiRemoveGroupCallable", (new StringBuilder("[MGCC] addCallback errorCode = ")).append(e1).toString());
        if (e1 == null)
        {
