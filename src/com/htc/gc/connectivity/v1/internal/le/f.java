    ...
    implements a
{
    ...
    f(GcBluetoothLeService gcbluetoothleservice, int i, BluetoothDevice bluetoothdevice)
    {
    ...
    public void a()
    {
        Log.d(GcBluetoothLeService.c(), "[MGCC] setTimeoutRequestAlarm TIMEOUT_WIFI_CONNECTING onAlarm");
