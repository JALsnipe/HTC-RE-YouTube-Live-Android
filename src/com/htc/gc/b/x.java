...
public class x extends d
{
    ...
    public void a(InputStream inputstream, cc cc)
    {
        ...
        try
        {
            ...
            bytebuffer = a(inputstream, 201, new m(), ((com.htc.gc.interfaces.cb) (cc)), true);
        ...
        b.a(a, ax.a(bytebuffer.get()), bytebuffer.getInt());
        return;
        exception1;
    ...
    public void a(OutputStream outputstream)
    {
        try
        {
            ...
            a(outputstream, 201, 0, null, true);
            return;
        }
        catch (Exception exception)
        {
