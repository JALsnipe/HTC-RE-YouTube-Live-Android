...
public class GcSeekBar extends SeekBar
{
    ...
    public GcSeekBar(Context context, AttributeSet attributeset)
    {
        this(context, attributeset, 0x7f010084);
    }

    public GcSeekBar(Context context, AttributeSet attributeset, int i1)
    {
        ...
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, new int[] {
            0x10100b2, 0x10100d6, 0x10100d8, 0x1010142, 0x1010143, 0x7f010066
        }, i1, 0x7f0f029e);
        int j1 = typedarray.getResourceId(0, 0);
        d = typedarray.getDrawable(3);
        int k1 = typedarray.getDimensionPixelOffset(4, getThumbOffset());
        int l1 = typedarray.getInt(5, 0);
        typedarray.recycle();
        a = getContext().getResources().getDimensionPixelOffset(0x7f0801ac);
        setThumbOffset(k1);
...
_L4:
    ...
    private void a(Canvas canvas)
    {
        if (j == null)
        {
            j = getContext().getResources().getDrawable(0x7f02004b);
            j.mutate();
            j.setColorFilter(new PorterDuffColorFilter(getContext().getResources().getColor(0x7f0e000a), android.graphics.PorterDuff.Mode.SRC_ATOP));
        }
        canvas.save();
    ...
    private Drawable b(int i1)
    {
        if (1 == i1)
        {
            return getContext().getResources().getDrawable(0x7f020123);
        } else
        {
            return getContext().getResources().getDrawable(0x7f020122);
        }
    }
    ...
    private void setSeekBarDrawableBundary(Drawable drawable)
    {
        if (drawable != null)
        {
            ...
            int l1 = getResources().getColor(0x7f0e00c6);
            if (drawable3 != null)
            {
                drawable3.setBounds(rect2);
                drawable3.setColorFilter(l1, android.graphics.PorterDuff.Mode.SRC_ATOP);
                return;
            }
        }
    }
