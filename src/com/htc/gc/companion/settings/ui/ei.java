    ...
    implements t
{
    ...
    ei(TimeLapseSettingActivity timelapsesettingactivity)
    {
    ...
    {
        Log.e("TimeLapseSettingActivity", (new StringBuilder()).append("mTimelapseSetFrameRateCb: ").append(exception.toString()).toString());
    ...
    public void a(Object obj)
    {
        try
        {
            TimeLapseSettingActivity.q(a).a(new ej(this));
        }
