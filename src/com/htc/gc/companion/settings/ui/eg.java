    ...
    implements t
{
    ...
    eg(TimeLapseSettingActivity timelapsesettingactivity)
    {
    ...
    {
        Log.e("TimeLapseSettingActivity", (new StringBuilder()).append("mTimelapseSetIntCb: ").append(exception.toString()).toString());
    ...
    public void a(Object obj)
    {
        try
        {
            TimeLapseSettingActivity.q(a).a(new eh(this));
        }
