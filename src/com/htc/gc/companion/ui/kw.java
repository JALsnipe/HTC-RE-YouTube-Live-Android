    ...
    implements t
{
    ...
    kw(ViewfinderActivity viewfinderactivity)
    {
    ...
    {
        Log.e("ViewfinderActivity", (new StringBuilder()).append("mTimelapseSetIntCb: ").append(exception.toString()).toString());
    ...
    public void a(Object obj)
    {
        try
        {
            ViewfinderActivity.z(a).a(new kx(this));
        }
