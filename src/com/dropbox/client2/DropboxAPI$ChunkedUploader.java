...
_L8:
        ...
        {
            upload1 = new init>(progresslistener, offset, targetLength);
        }
...
_L6:
        lastRequest = chunkedUploadRequest(new ByteArrayInputStream(chunk), bytesInChunkToUpload, upload1, offset, uploadId);
        this;
        JVM INSTR monitorexit ;
        ponse ponse = lastRequest.upload();
        offset = ponse.getOffset();
        uploadId = ponse.getUploadId();
        bytesInChunkToUpload = 0;
          goto _L11
