    ...
    implements Iterable
{
    ...
    public void expectLength(int i)
    {
        ...
        {
            throw error((new StringBuilder()).append("expecting array to have length ").append(i).append(", but it has length ").append(((List)internal).size()).toString());
        } else
        {
            return;
        }
    ...
    public ArrayList extract(JsonExtractor jsonextractor)
    {
    ...
    public JsonThing get(int i)
    {
        ...
        {
            throw error((new StringBuilder()).append("expecting array to have an element at index ").append(i).append(", but it only has length ").append(((List)internal).size()).toString());
        } else
        {
