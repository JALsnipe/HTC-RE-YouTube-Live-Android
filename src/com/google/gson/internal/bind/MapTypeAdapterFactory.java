    ...
    implements TypeAdapterFactory
{
    ...
    private static JsonElement toJsonTree(TypeAdapter typeadapter, Object obj)
    {
    ...
    private class Adapter extends TypeAdapter
    {
        ...
        public void write(JsonWriter jsonwriter, Map map)
        {
            ...
            while (iterator.hasNext()) 
            {
                ...
                JsonElement jsonelement = MapTypeAdapterFactory.toJsonTree(keyTypeAdapter, entry.getKey());
