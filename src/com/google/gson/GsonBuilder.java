...
_L6:
        list.add(TreeTypeAdapter.newFactory(TypeToken.get(java/util/Date), defaultdatetypeadapter));
        list.add(TreeTypeAdapter.newFactory(TypeToken.get(java/sql/Timestamp), defaultdatetypeadapter));
        list.add(TreeTypeAdapter.newFactory(TypeToken.get(java/sql/Date), defaultdatetypeadapter));
_L4:
        return;
_L2:
        if (i == 2 || j == 2) goto _L4; else goto _L3
_L3:
        defaultdatetypeadapter = new DefaultDateTypeAdapter(i, j);
...
_L5:
    ...
    public GsonBuilder registerTypeAdapter(Type type, Object obj)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Cannot register type adapters for ").append(type).toString());
        }
