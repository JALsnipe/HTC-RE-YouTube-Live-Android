...
_L5:
    ...
    private d hk()
    {
        Object obj = new b(getContext(), null);
        if (!((d) (obj)).isValid())
        {
            obj = new c(getContext(), null);
        }
        if (!((d) (obj)).isValid())
        {
            obj = new a(getContext(), null);
        }
        return ((d) (obj));
    }
...
_L2:
        ...
        b(Context context, _cls1 _pcls1)
        {
            this(context);
        }
    }
...
_L5:
        ...
        c(Context context, _cls1 _pcls1)
        {
            this(context);
        }
    }
        ...
        implements d
    {
        ...
        a(Context context, _cls1 _pcls1)
        {
            this(context);
        }
    }
