...
_L10:
        ...
        aa.t((new StringBuilder()).append("Error parsing tracker configuration file: ").append(xmlpullparserexception).toString());
_L2:
        return rb.bz();
_L9:
...
_L14:
        ...
        aa.t((new StringBuilder()).append("Error parsing bool configuration value: ").append(s4).toString());
          goto _L4
        IOException ioexception;
        ioexception;
        aa.t((new StringBuilder()).append("Error parsing tracker configuration file: ").append(ioexception).toString());
          goto _L2
_L12:
...
_L17:
        ...
        aa.t((new StringBuilder()).append("Error parsing int configuration value: ").append(s2).toString());
          goto _L4
    }
    ...
    public j p(int i)
    {
        ...
        {
            aa.w((new StringBuilder()).append("inflate() called with unknown resourceId: ").append(notfoundexception).toString());
            return null;
        }
        return j;
    }
