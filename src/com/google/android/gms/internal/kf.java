...
_L1:
        return;
_L2:
        if (!(obj instanceof ke)) goto _L4; else goto _L3
_L3:
        int i;
        Class class1;
        Method amethod[];
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(bR(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String ap(String s)
    {
        int i = s.length();
    ...
    public static String e(ke ke1)
    {
        ...
        try
        {
            a(null, ke1, new StringBuffer(), stringbuffer);
        }
