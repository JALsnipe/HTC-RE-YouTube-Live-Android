...
//            GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException, b, ErrorDialogFragment
...
public final class GooglePlayServicesUtil
{
    ...
    public static final int GOOGLE_PLAY_SERVICES_VERSION_CODE = 0x41f6b8;
...
_L3:
        return flag;
_L2:
        if (!_mthdo()) goto _L3; else goto _L5
_L5:
        return false;
_L4:
        return false;
    ...
    private static byte[] Z(String s1)
    {
        byte abyte0[];
        try
        {
            abyte0 = s1.getBytes("ISO-8859-1");
        }
    ...
    public static Dialog a(int j, Activity activity, int k, android.content.DialogInterface.OnCancelListener oncancellistener, int l)
    {
        android.app.AlertDialog.Builder builder = (new android.app.AlertDialog.Builder(activity)).setMessage(b(activity, j, l));
        if (oncancellistener != null)
        {
            builder.setOnCancelListener(oncancellistener);
        }
        ef ef1 = new ef(activity, a(((Context) (activity)), j, l), k);
        String s1 = b(activity, j);
        if (s1 != null)
        {
            builder.setPositiveButton(s1, ef1);
        }
        switch (j)
        {
        default:
    ...
    public static Intent a(Context context, int j, int k)
    {
        switch (j)
        {
        default:
    ...
    private static transient byte[] a(PackageInfo packageinfo, byte abyte0[][])
    {
        ...
        abyte1 = packageinfo.signatures[0].toByteArray();
    ...
    public static String b(Context context, int j, int k)
    {
        Resources resources = context.getResources();
        j;
...
_L1:
        String s1 = resources.getString(com.google.android.gms.R.string.common_google_play_services_unknown_issue);
_L10:
        return s1;
_L2:
        if (a(context.getResources()))
        {
            s1 = resources.getString(com.google.android.gms.R.string.common_google_play_services_install_text_tablet);
        } else
        {
            s1 = resources.getString(com.google.android.gms.R.string.common_google_play_services_install_text_phone);
        }
        if (!E(k)) goto _L10; else goto _L9
_L9:
        return (new StringBuilder()).append(s1).append(" (via Bazaar)").toString();
_L4:
        return resources.getString(com.google.android.gms.R.string.common_google_play_services_enable_text);
_L3:
        s1 = resources.getString(com.google.android.gms.R.string.common_google_play_services_update_text);
        if (!E(k)) goto _L10; else goto _L11
_L11:
        return (new StringBuilder()).append(s1).append(" (via Bazaar)").toString();
_L7:
...
_L8:
    ...
    private static boolean b(Resources resources)
    {
        ...
        if (flag)
        {
            int j = 0xf & configuration.screenLayout;
            flag1 = false;
            if (j <= 3)
            {
    ...
    {
        return a(j, activity, k, oncancellistener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int j, Context context, int k)
    {
        Intent intent = a(context, j, -1);
        if (intent == null)
        {
            return null;
        } else
        {
            return PendingIntent.getActivity(context, k, intent, 0x10000000);
        }
    }
    ...
    abyte0
        ...
        if (packageinfo.versionCode < 0x41f6b8)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder()).append("Google Play services out of date.  Requires 4323000 but found ").append(packageinfo.versionCode).toString());
            return 2;
        }
    ...
    {
        int j = isGooglePlayServicesAvailable(context);
        if (j != 0)
        {
            Intent intent = a(context, j, -1);
            Log.e("GooglePlayServicesUtil", (new StringBuilder()).append("GooglePlayServices not available due to error ").append(j).toString());
            if (intent == null)
            {
                throw new GooglePlayServicesNotAvailableException(j);
            } else
            {
                throw new GooglePlayServicesRepairableException(j, "Google Play Services not available", intent);
            }
        } else
        {
            return;
    ...
    {
        Dialog dialog = getErrorDialog(j, activity, k, oncancellistener);
        if (dialog == null)
        {
            return false;
        }
        ...
        if (flag)
        {
            android.support.v4.app.o o = ((i)activity).e();
            com.google.android.gms.common.b.a(dialog, oncancellistener).show(o, "GooglePlayServicesErrorDialog");
        } else
        if (fr.eJ())
        {
...
_L1:
        ...
        if (bundle != null)
        {
            int j = bundle.getInt("com.google.android.gms.version");
    ...
    private static boolean u(Context context)
    {
        ...
        } else
        {
            ...
            try
            {
                abyte0 = a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), yR);
            }
            catch (android.content.pm.PackageManager.NameNotFoundException namenotfoundexception)
            {
                return false;
