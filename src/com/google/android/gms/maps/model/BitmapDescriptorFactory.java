...
public final class BitmapDescriptorFactory
{
    ...
    public static BitmapDescriptor defaultMarker()
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().hi());
        }
    ...
    public static BitmapDescriptor defaultMarker(float f)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().c(f));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromAsset(String s)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().aL(s));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromBitmap(Bitmap bitmap)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().b(bitmap));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromFile(String s)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().aM(s));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromPath(String s)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().aN(s));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromResource(int i)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(hd().bz(i));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
