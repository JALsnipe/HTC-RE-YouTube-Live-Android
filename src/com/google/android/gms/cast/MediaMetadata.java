...
_L3:
        break MISSING_BLOCK_LABEL_264;
_L4:
        jsonobject.put(wS.M(s), wT.getString(s));
        break MISSING_BLOCK_LABEL_264;
_L5:
        jsonobject.put(wS.M(s), wT.getInt(s));
        break MISSING_BLOCK_LABEL_264;
_L6:
        jsonobject.put(wS.M(s), wT.getDouble(s));
        break MISSING_BLOCK_LABEL_264;
_L2:
        iterator = wT.keySet().iterator();
_L9:
        do
        {
            if (!iterator.hasNext())
...
_L7:
        ...
        try
        {
            if ((obj instanceof String) && dz.V((String)obj) != null)
            {
                wT.putString(s1, (String)obj);
            }
        }
...
_L5:
        ...
        {
            wT.putInt(s1, ((Integer)obj).intValue());
        }
        continue; /* Loop/switch isn't completed */
_L6:
        if (obj instanceof Double)
        {
            wT.putDouble(s1, ((Double)obj).doubleValue());
        }
        continue; /* Loop/switch isn't completed */
_L2:
        ...
        {
            wT.putString(s, (String)obj1);
            continue; /* Loop/switch isn't completed */
        }
        if (obj1 instanceof Integer)
        {
            wT.putInt(s, ((Integer)obj1).intValue());
            continue; /* Loop/switch isn't completed */
        }
        try
        {
            ...
            {
                wT.putDouble(s, ((Double)obj1).doubleValue());
            }
            continue; /* Loop/switch isn't completed */
        }
        catch (JSONException jsonexception) { }
...
_L8:
    ...
    private void d(String s, int i)
    {
        ...
        if (j != i && j != 0)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Value for ").append(s).append(" must be a ").append(wR[i]).toString());
        } else
        {
            return;
        }
    ...
    public void b(JSONObject jsonobject)
    {
        ...
        try
        {
            wU = jsonobject.getInt("metadataType");
        }
        catch (JSONException jsonexception) { }
        dz.a(wl, jsonobject);
        switch (wU)
    ...
    public JSONObject cT()
    {
        ...
        try
        {
            jsonobject.put("metadataType", wU);
        }
        catch (JSONException jsonexception) { }
        dz.a(jsonobject, wl);
        switch (wU)
    ...
    public boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (!a(wT, mediametadata.wT) || !wl.equals(mediametadata.wl))
            {
                return false;
            }
        }
    ...
    {
        d(s, 4);
        return wT.getString(s);
    }

    public double getDouble(String s)
    {
        d(s, 3);
        return wT.getDouble(s);
    }
    ...
    {
        return wl != null && !wl.isEmpty();
    }

    public int hashCode()
    {
        Iterator iterator = wT.keySet().iterator();
        int i;
        String s;
        for (i = 17; iterator.hasNext(); i = i * 31 + wT.get(s).hashCode())
        {
            s = (String)iterator.next();
        }

        return i * 31 + wl.hashCode();
    }
