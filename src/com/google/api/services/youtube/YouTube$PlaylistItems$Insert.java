...
public class part extends YouTubeRequest
{
    ...
    protected JsonClientRequest(String s, PlaylistItem playlistitem)
    {
        this$1 = this._cls1.this;
        super(_fld1, "POST", "playlistItems", playlistitem, com/google/api/services/youtube/model/PlaylistItem);
