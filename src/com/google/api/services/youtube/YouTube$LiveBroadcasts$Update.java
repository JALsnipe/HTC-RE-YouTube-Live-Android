...
public class checkRequiredParameter extends YouTubeRequest
{
    ...
    protected sonClientRequest(String s, LiveBroadcast livebroadcast)
    {
        ...
        super(_fld1, "PUT", "liveBroadcasts", livebroadcast, com/google/api/services/youtube/model/LiveBroadcast);
