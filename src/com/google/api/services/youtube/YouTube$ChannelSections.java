...
public class this._cls0
{
    ...
    public Delete delete(String s)
    {
        class Delete extends YouTubeRequest
        {
            ...
            {
                this$1 = YouTube.ChannelSections.this;
                super(this$0, "DELETE", "channelSections", null, java/lang/Void);
    ...
    public Insert insert(String s, ChannelSection channelsection)
    {
        class Insert extends YouTubeRequest
        {
            ...
            {
                this$1 = YouTube.ChannelSections.this;
                super(this$0, "POST", "channelSections", channelsection, com/google/api/services/youtube/model/ChannelSection);
    ...
    public List list(String s)
    {
        class List extends YouTubeRequest
        {
            ...
            {
                this$1 = YouTube.ChannelSections.this;
                super(this$0, "GET", "channelSections", null, com/google/api/services/youtube/model/ChannelSectionListResponse);
                part = (String)Preconditions.checkNotNull(s, "Required parameter part must be specified.");
            }
        }
    ...
    public Update update(String s, ChannelSection channelsection)
    {
        class Update extends YouTubeRequest
        {
            ...
            {
                this$1 = YouTube.ChannelSections.this;
                super(this$0, "PUT", "channelSections", channelsection, com/google/api/services/youtube/model/ChannelSection);
                part = (String)Preconditions.checkNotNull(s, "Required parameter part must be specified.");
            }
        }
