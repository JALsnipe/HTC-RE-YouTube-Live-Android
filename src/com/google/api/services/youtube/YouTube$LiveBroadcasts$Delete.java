...
public class id extends YouTubeRequest
{
    ...
    public onBehalfOfContentOwnerChannel setPrettyPrint(Boolean boolean1)
    {
        return (onBehalfOfContentOwnerChannel)super.setPrettyPrint(boolean1);
    }
    ...
    protected sonClientRequest(String s)
    {
        ...
        super(_fld1, "DELETE", "liveBroadcasts", null, java/lang/Void);
