...
public class part extends YouTubeRequest
{
    ...
    protected JsonClientRequest(String s, Subscription subscription)
    {
        this$1 = this._cls1.this;
        super(_fld1, "POST", "subscriptions", subscription, com/google/api/services/youtube/model/Subscription);
