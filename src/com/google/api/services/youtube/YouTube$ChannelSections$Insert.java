...
public class part extends YouTubeRequest
{
    ...
    protected onClientRequest(String s, ChannelSection channelsection)
    {
        this$1 = this._cls1.this;
        super(_fld1, "POST", "channelSections", channelsection, com/google/api/services/youtube/model/ChannelSection);
