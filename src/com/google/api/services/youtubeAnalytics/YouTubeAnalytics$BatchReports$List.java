...
public class onBehalfOfContentOwner extends YouTubeAnalyticsRequest
{
    ...
    public setAlt setBatchReportDefinitionId(String s)
    {
        batchReportDefinitionId = s;
        return this;
    }

    public batchReportDefinitionId setFields(String s)
    {
        return (batchReportDefinitionId)super.setFields(s);
    }
    ...
    protected st(String s, String s1)
    {
