...
public abstract class  extends com.google.api.client.googleapis.services.lder
{
    ...
    protected (HttpTransport httptransport, JsonFactory jsonfactory, String s, String s1, HttpRequestInitializer httprequestinitializer, boolean flag)
    {
        ...
        super(httptransport, s, s1, builder.erKeys(((java.util.Collection) (obj))).erKeys(), httprequestinitializer);
    }
}
