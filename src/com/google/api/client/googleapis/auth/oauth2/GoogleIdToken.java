...
public class GoogleIdToken extends IdToken
{
    ...
    {
        JsonWebSignature jsonwebsignature = JsonWebSignature.parser(jsonfactory).setPayloadClass(com/google/api/client/googleapis/auth/oauth2/GoogleIdToken$Payload).parse(s);
    ...
    private class Payload extends com.google.api.client.auth.openidconnect.IdToken.Payload
    {
