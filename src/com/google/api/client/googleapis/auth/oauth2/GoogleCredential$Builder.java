...
public class setTokenServerEncodedUrl extends com.google.api.client.auth.oauth2.al.Builder
{
    ...
    {
        ls ls = googleclientsecrets.getDetails();
        setClientAuthentication(new ClientParametersAuthentication(ls.getClientId(), ls.getClientSecret()));
        return this;
    }
    ...
    {
        byte abyte0[] = PemReader.readFirstSectionAndClose(new FileReader(file), "PRIVATE KEY")._mth64DecodedBytes();
        serviceAccountPrivateKey = SecurityUtils.getRsaKeyFactory().generatePrivate(new PKCS8EncodedKeySpec(abyte0));
        return this;
    }

    public serviceAccountPrivateKey setServiceAccountScopes(Collection collection)
    {
