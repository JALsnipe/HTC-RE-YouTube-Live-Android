...
public class GoogleIdTokenVerifier extends IdTokenVerifier
{
    ...
    {
        GoogleIdToken googleidtoken = GoogleIdToken.parse(getJsonFactory(), s);
    ...
    public boolean verify(GoogleIdToken googleidtoken)
    {
        ...
        for (Iterator iterator = publicKeys.getPublicKeys().iterator(); iterator.hasNext();)
        {
    ...
    private class Builder extends com.google.api.client.auth.openidconnect.IdTokenVerifier.Builder
    {
