...
//            AbstractMemoryDataStore, MemoryDataStoreFactory, DataStoreFactory

class  extends AbstractMemoryDataStore
{
    ...
    (MemoryDataStoreFactory memorydatastorefactory, String s)
    {
